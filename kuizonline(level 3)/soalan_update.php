...
$jenis = $_POST['jenis'];
$sql = "UPDATE soalan SET namasoalan='$namasoalan', pilihana='$pilihana', pilihanb='$pilihanb', pilihanc='$pilihanc', jawapan='$jawapan', idguru='$idguru', idtopik='$idtopik', jenis='$jenis' WHERE idsoalan='$idsoalan'";
...
<div class="all">
	...
	<div class="kandungan">
		<div id="berjaya" style="display: none;">
			...
			<h2 class="mesej">Berjaya update</h2>
		</div>

		<div id="tidak" style="display: none;">
			<h3 class="panjang">MESEJ</h3>
			<h2 class="mesej">Tidak berjaya update</h2>
		</div>
